<template>
  <div class="login">
    ...
    <div class="pass_box1">
      <input cursor-spacing="20" v-model="password" class="pass_box_inp" type="password" placeholder="请输入新密码" maxlength="16">
    </div>

    <button class="btn" @tap="registerFunc" :loading="loading">修改</button>
