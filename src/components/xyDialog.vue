	...
	<view class="dialog">
		...
		<view class="dialog-wrap">
			...
			<view class="dialog-hairline--top dialog-footer">
				<text class="footer-btn footer-cancel" v-if="showCancelButton" @click="handleClose">{{ cancelButtonText }}</text>
				<text class="footer-btn footer-success" :class="{'dialog-hairline--left': showCancelButton}" v-if="showConfirmButton" @click="handleConfirm">{{ confirmButtonText }}</text>
			</view>
		</view>
	</view>
</template>
...
<style lang="scss" scoped>
	.dialog-hairline--left::after,.dialog-hairline--top::after {
	  content: " ";
	  position: absolute;
	  pointer-events: none;
